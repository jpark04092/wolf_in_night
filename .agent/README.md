...
* **핵심 컨셉**:
  ...
  9. **아침 토론 타임라인 및 추론 가이드**: 이번 게임에 투입된 전체 카드 덱 요약(`state.deck`)과 공식 룰에 따른 밤 액션 진행 순서(늑대인간 → 하수인 → 예언자 → 강도 → 말썽쟁이 → 주정뱅이 → 불면증환자) 및 직업별 핵심 추론 팁을 실시간 아코디언 타임라인으로 제공하여 플레이어들이 카드 교환의 선후 관계를 기반으로 정확한 논리적 추론을 펼칠 수 있도록 지원.
